...
export class ErbilGovernor extends BaseGovernor {
  category = "Erbil";
  agentName = "Gov-04 Erbil";
  ...
  async gather(): Promise<any[]> {
    ...
    if (!apiKey || apiKey === "your-google-places-api-key") {
      ...
      return [
        {
          name: "Erbil Heritage Restaurant",
    ...
    try {
      ...
      const query = encodeURIComponent("best restaurants in Erbil, Iraq");
