...
export class WasitGovernor extends BaseGovernor {
  category = "Wasit";
  agentName = "Gov-13 Wasit";
  ...
  async gather(): Promise<any[]> {
    ...
    if (!apiKey || apiKey === "your-google-places-api-key") {
      ...
      return [
        {
          name: "Wasit Heritage Restaurant",
    ...
    try {
      ...
      const query = encodeURIComponent("best restaurants in Wasit, Iraq");
