...
export class SaladinGovernor extends BaseGovernor {
  category = "Saladin";
  agentName = "Gov-18 Saladin";
  ...
  async gather(): Promise<any[]> {
    ...
    if (!apiKey || apiKey === "your-google-places-api-key") {
      ...
      return [
        {
          name: "Saladin Heritage Restaurant",
    ...
    try {
      ...
      const query = encodeURIComponent("best restaurants in Saladin, Iraq");
