...
export class MosulGovernor extends BaseGovernor {
  category = "Mosul (Nineveh)";
  agentName = "Gov-09 Mosul (Nineveh)";
  ...
  async gather(): Promise<any[]> {
    ...
    if (!apiKey || apiKey === "your-google-places-api-key") {
      ...
      return [
        {
          name: "Mosul (Nineveh) Heritage Restaurant",
        ...
        {
          name: "Mosul (Nineveh) Riverside Grill",
          category: this.category,
    ...
    try {
      ...
      const query = encodeURIComponent("best restaurants in Mosul (Nineveh), Iraq");
