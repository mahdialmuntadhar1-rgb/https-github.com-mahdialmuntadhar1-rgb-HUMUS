...
export class MuthannaGovernor extends BaseGovernor {
  category = "Muthanna";
  agentName = "Gov-16 Muthanna";
  ...
  async gather(): Promise<any[]> {
    ...
    if (!apiKey || apiKey === "your-google-places-api-key") {
      ...
      return [
        {
          name: "Muthanna Heritage Restaurant",
    ...
    try {
      ...
      const query = encodeURIComponent("best restaurants in Muthanna, Iraq");
