...
export class DiyalaGovernor extends BaseGovernor {
  category = "Diyala";
  agentName = "Gov-11 Diyala";
  ...
  async gather(): Promise<any[]> {
    ...
    if (!apiKey || apiKey === "your-google-places-api-key") {
      ...
      return [
        {
          name: "Diyala Heritage Restaurant",
    ...
    try {
      ...
      const query = encodeURIComponent("best restaurants in Diyala, Iraq");
