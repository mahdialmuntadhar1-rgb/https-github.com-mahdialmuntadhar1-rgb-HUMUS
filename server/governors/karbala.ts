...
export class KarbalaGovernor extends BaseGovernor {
  category = "Karbala";
  agentName = "Gov-08 Karbala";
  ...
  async gather(): Promise<any[]> {
    ...
    if (!apiKey || apiKey === "your-google-places-api-key") {
      ...
      return [
        {
          name: "Karbala Heritage Restaurant",
    ...
    try {
      ...
      const query = encodeURIComponent("best restaurants in Karbala, Iraq");
