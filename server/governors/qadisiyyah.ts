...
export class QadisiyyahGovernor extends BaseGovernor {
  category = "Qadisiyyah";
  agentName = "Gov-17 Qadisiyyah";
  ...
  async gather(): Promise<any[]> {
    ...
    if (!apiKey || apiKey === "your-google-places-api-key") {
      ...
      return [
        {
          name: "Qadisiyyah Heritage Restaurant",
        ...
        {
          name: "Qadisiyyah Riverside Grill",
          category: this.category,
    ...
    try {
      ...
      const query = encodeURIComponent("best restaurants in Qadisiyyah, Iraq");
